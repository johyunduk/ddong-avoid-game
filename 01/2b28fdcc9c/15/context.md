...
@public/assets/wallpapers/fantasy.png 이거 추가했는데 다른 배경들 처럼 webp 로 만들고 배경화면 목록, 뽑기에 추가, 그리고 knight 캐릭터와 시너지 추가해줘. 배경 추가했을 때 추가해야 되는데 빠진거 있으면 알려주고
...
@public/assets/wallpapers/fantasy.png 이거 무손실 webp로 만들어서 지금 @public/assets/wallpapers/fantasy_bg.webp 이거 대체해줘
